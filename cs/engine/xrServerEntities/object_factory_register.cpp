...
#	include "WeaponZoomable.h" // weapon with zooming scope
...
//	add<CSE_SpawnGroup>											(CLSID_AI_SPAWN_GROUP			,"spawn_group");
	...
	ADD(CWeaponAutomaticShotgun ,CSE_ALifeItemWeaponShotGun		,CLSID_OBJECT_W_ASHTGUN			,"wpn_ashtgun");
	...
	ADD(CWeaponZoomable			,CSE_ALifeItemWeaponMagazinedWGL,CLSID_OBJECT_W_ZOOM			,"wpn_zoom");
	//-----------------------------------------------------------------------------------------------------

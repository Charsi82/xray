...
public:
	...
	void SetFlags(Flags16 data) { m_flags = data; };
	Flags16 GetFlags(){	return m_flags;	};
public:
	...
	virtual bool				Action				(s32 cmd, u32 flags) {return false;}	// true åñëè èçâåñòíàÿ êîìàíäà, èíà÷å false

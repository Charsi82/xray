...
void CScientificDetector::CreateUI()
{
	R_ASSERT(NULL == m_ui);
	m_ui = new CUIArtefactDetectorSci();
	ui().construct(this);
}

CUIArtefactDetectorSci&  CScientificDetector::ui()
{
	return *((CUIArtefactDetectorSci*)m_ui);
}

bool CScientificDetector::render_item_3d_ui_query()
{
	return IsWorking();
}

void CScientificDetector::render_item_3d_ui()
{
...
//////// CUIArtefactDetectorSci /////////////

void CUIArtefactDetectorSci::construct(CScientificDetector* p)
{
	m_parent = p;
	CUIXml								uiXml;
...
void CUIArtefactDetectorSci::update()
{
	inherited::update();
	CUIWindow::Update();
}

void CUIArtefactDetectorSci::Draw()
{
...
void CUIArtefactDetectorSci::GetUILocatorMatrix(Fmatrix& _m)
{
...
void CUIArtefactDetectorSci::Clear()
{
	m_items_to_draw.clear();
}

void CUIArtefactDetectorSci::RegisterItemToDraw(const Fvector& p, const shared_str& palette_idx)
{
